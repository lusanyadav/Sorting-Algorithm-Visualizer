...
# In this project we are creating a sorting algorithm visualizer which will sort and visualize different sorting algorithm

# sorting algorithm used in this project are bubble sort, insertion sort, merge sort and quick sort

# And at the end of sorting, we get a time = x, which means x time taken by sorting algorithm to sort the list(array)
